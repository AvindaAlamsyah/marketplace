	...
	<section class="shipping bgwhite p-t-62 p-b-46">
		<div align="center" class="p-l-15 p-r-15">
			<h4 class="m-text20 p-b-24" id="test">
				Formulir beli produk
			</h4>
			<div class="container bo4">
				<div class="p-t-25 p-b-25 p-l-100 p-r-100">
					<form action="<?php echo base_url('Pasar/simpanBeli'); ?>" onkeypress="return event.keyCode != 13;" id="postBeli">
						...
						<div class="bo4 size15 m-b-20 form-group form-group-lg has-feedback">
							<input class="sizefull s-text7 p-l-22 p-r-22 form-control textbox" type="text" name="kebutuhan" id="kebutuhan" placeholder="Kebutuhan Produk (Ekor)">
							<i class="form-control-feedback"></i>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#posting').click(function(){
				var valid = true;
				$('#postBeli').find('.textbox').each(function(){
					if (! $(this).val()) {
						get_error_text(this);
						valid = false;
				...
				if(valid == true){
					swal({
						...
						/*
							...
							*/
							var data = new FormData('#postBeli');
							...
							data.append('kebutuhan', $('#kebutuhan').val());

							$.ajax({
								url: "<?php echo base_url('Pasar/simpanBeli'); ?>",
								type: "POST",
								cache: false,
								contentType: false,
								processData: false,
